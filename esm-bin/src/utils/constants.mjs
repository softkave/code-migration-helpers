...
export const kJSOrTSTestFilepathRegex = /\.(?:test|spec)\.(?:ts|js|mjs|mts|cjs|cts|tsx|jsx)$/;
export const kCaptureDirAndBasenameFromJSOrTSFilepathRegex = /^(?<dirAndBasename>.*)\.?\.(?:ts|js|mjs|mts|cjs|cts|tsx|jsx)$/;
